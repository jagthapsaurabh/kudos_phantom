...
const files = targets.length ? targets : ['trade_log_ui.jsx', 'trading_windows_ui.jsx', 'pages_smoke.jsx', 'terminal_ui.jsx', 'admin_seed_ui.jsx', 'chart_overlay.jsx', 'broker_keys_ui.jsx'];
